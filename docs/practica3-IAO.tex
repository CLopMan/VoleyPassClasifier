...
\pagenumbering{arabic} % numeración con múmeros arábigos para el resto de la publicación
    ...
    En el mundo de los deportes siempre se ha usado la estadística con el fin
    de medir el rendimiento y la mejora de los deportistas y equipos durante el
    periodo competitivo. En el volleyball español se emplean principalmente dos
    ...
    esta actividad presente ventajas frente al esfuerzo que require. Hablando
    en concreto de madrid, existen 99 clubes~\cite{directorio-clubes} y más de
    6000 deportistas~\cite{estadisticasFEVB}; mientras que sólamente existen
    ...
    licencia más económica parte en los 299\euro. 
    ...
    españa es un deporte minoritario. Además, un partido de voley puede durar
    ...
    traduce en que a muchos entrenadores les resulte imposible invertir el
    ...
    grabaciones de buena calidad que puedan ser fácilmente analizadas. La
    mayoría de entrenadores que realizan la toma de estadísticas en diferido lo
    hacen por iniciativa propia. Esto desincentiva la actividad, haciendo de la
    toma de estadísticas en diferido un lujo que pueden permitirse sólo los
    clubes con mayor poder adquisitivo para facilitar la infraestructura a sus
    entrenadores.
    ...
    etiquetan vídeos de volleyball profesional. La primera contiene 4830
    ...
    la secuencia, asi como la posición y acción de cada jugador durante los
    frames 11 a 30. La segunda base de datos utiliza el mismo conjunto de videos
    y secuencias, pero etiqueta la posición de la bola en cada frame de cada
    secuencia.

    Ya que el objetivo de este trabajo es la clasificación de pases, estos datos
    se han filtrado a las secuencias con la clase \verb!r_set! o \verb!l_set!.
    Esto reduce el número de secuencias etiquetadas a 1276. Cada una de estas
    secuencias se ha etiquetado manualmente según si contiene un pase correcto
    o incorrecto.
