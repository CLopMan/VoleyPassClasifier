...
%    a 3 la probabilidad será 1, si es 4 o 5 será 0.6 y si es 6 o más será 0.3. 
    ...
    Se ha menguado el conjunto de datos de instancias positivas en un 50\%. Esto permite una mayor proporción de instancias negativas, manteniendo una gran representatividad de la clase positiva.
...
%    frames se etiquetan con la clase de espera.
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
            \node (img) at (0,0) {\includegraphics[width=0.9\linewidth]{falso_positivo_icono.jpeg}};
            \node[] (txt) at (2.25, 4.5) {Bola real};
            \draw[red, very thick, ->] (txt.south) -- (2.25, 0.7);
        \end{tikzpicture}
    ...
    \label{div_carpetas}
    \lstinputlisting[language=Python]{../scripts/oversampling.py}
\end{document}
