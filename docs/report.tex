...
\pagenumbering{arabic} % numeración con múmeros arábigos para el resto de la publicación
    ...
    La segunda base de datos utiliza el mismo conjunto de videos y secuencias,
    ...
    Ya que este trabajo está centrado en los pases, los datos de la primera base
    de datos se han filtrado a las secuencias con la clase \verb!r_set! o
    \verb!l_set!. Esto reduce el número de secuencias etiquetadas a 1276. Cada
